...
const Diagnostico = () => {
  ...
  // --- CONFIGURACIÓN DE METAS (Target Semanal) ---
  const METAS = {
  ...
  const fetchDiagnostico = async () => {
    ...
    try {
      ...
      if (res && res.length > 0) {
        ...
        // 2. Procesamos energía de la semana actual por materia
        ...
        // Buscamos la materia que históricamente tiene el promedio más bajo
      ...
      <div style={styles.content}>
        ...
        {loading ? (
          ...
          <div style={styles.dashboard}>
            ...
            {/* COMPARATIVA SEMANAL (Imagen Galaxy Brain) */}
            ...
            <div style={styles.mainGrid}>
              {/* SECTORES CRÍTICOS (Basados en Promedio Real) */}
              <div style={styles.glassCard}>
            ...
            {/* CELDAS DE ENERGÍA (Detalle por materia) */}
